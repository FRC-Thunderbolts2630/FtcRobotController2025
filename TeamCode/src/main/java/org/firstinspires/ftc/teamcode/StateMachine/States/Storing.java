...
public class Storing extends CommandBase {

    private ExtensionSubsystem m_extension;
    private PivotSubsystem m_pivot;
    private GripperSubsystem m_gripper;
    public Storing(GripperSubsystem gripperSubsystem, ExtensionSubsystem extensionSubsystem, PivotSubsystem pivotSubsystem){
