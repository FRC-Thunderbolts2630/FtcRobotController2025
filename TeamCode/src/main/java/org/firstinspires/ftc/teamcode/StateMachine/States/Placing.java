...
public class Placing extends CommandBase {

    private ExtensionSubsystem m_extension;
    private PivotSubsystem m_pivot;
    private GripperSubsystem m_gripper;
    public Placing(GripperSubsystem gripperSubsystem, ExtensionSubsystem extensionSubsystem, PivotSubsystem pivotSubsystem){
